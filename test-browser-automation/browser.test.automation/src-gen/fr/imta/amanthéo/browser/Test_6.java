...
public class Test_6 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        {
            String xpath = "//*[@id='recherche-date-range']//div[contains(@class, 'nice-select')]";
            List<WebElement> current = findElementsStable(driver, By.xpath(xpath), 10, 5);
            if (current.isEmpty()) {
                throw new WebDriverException("could not find any element matching xpath " + xpath);
            }
        ...
        {
            String xpath = "//*[@id='recherche-date-range']//div[contains(@class, 'nice-select')]//*[contains(text(), 'Le mois dernier')]";
            List<WebElement> current = findElementsStable(driver, By.xpath(xpath), 10, 5);
            if (current.isEmpty()) {
                throw new WebDriverException("could not find any element matching xpath " + xpath);
            }
