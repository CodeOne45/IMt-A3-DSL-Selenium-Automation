 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.OrdinalPredicateImpl#getOrdinal <em>Ordinal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrdinalPredicateImpl extends SelectorPredicateImpl implements OrdinalPredicate
{
  ...
  {
    return MyDslPackage.Literals.ORDINAL_PREDICATE;
  }
  ...
  public NotificationChain basicSetOrdinal(OrdinalInteger newOrdinal, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.ORDINAL_PREDICATE__ORDINAL, oldOrdinal, newOrdinal);
  ...
  public void setOrdinal(OrdinalInteger newOrdinal)
  {
    if (newOrdinal != ordinal)
    {
      ...
      if (ordinal != null)
        msgs = ((InternalEObject)ordinal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ORDINAL_PREDICATE__ORDINAL, null, msgs);
      if (newOrdinal != null)
        msgs = ((InternalEObject)newOrdinal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ORDINAL_PREDICATE__ORDINAL, null, msgs);
      msgs = basicSetOrdinal(newOrdinal, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ORDINAL_PREDICATE__ORDINAL, newOrdinal, newOrdinal));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.ORDINAL_PREDICATE__ORDINAL:
