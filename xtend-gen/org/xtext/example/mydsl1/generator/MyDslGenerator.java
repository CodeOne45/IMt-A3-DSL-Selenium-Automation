...
public class MyDslGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    Iterable<TestCase> _filter = Iterables.<TestCase>filter(IteratorExtensions.<EObject>toIterable(resource.getAllContents()), TestCase.class);
    for (final TestCase test : _filter) {
      {
        String name = test.getName().replaceAll("[^a-zA-Z0-9-_\\.]", "_");
        ...
        _builder.newLine();
        {
          EList<Command> _commands = test.getCommands();
        ...
        _builder.append("\t\t");
        _builder.append("if (driver == null) {");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("throw new RuntimeException(\"Cannot find a reference to the web driver. Has it been opened?\");");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("}");
        _builder.newLine();
    ...
    if (_domType != null) {
      switch (_domType) {
        ...
        case "text field":
          ...
          String _join = IterableExtensions.join(ListExtensions.<String, String>map(MyDslGenerator.TEXT_INPUTS, _function), " or ");
          String _plus = ("//*[" + _join);
          _switchResult = (_plus + "]");
          break;
        default:
