 ...
 * </p>
 * <ul>
 *   <li>{@link www.imta.fr.browserautomation.seleniumDsl.impl.ReadImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link www.imta.fr.browserautomation.seleniumDsl.impl.ReadImpl#getLinkText <em>Link Text</em>}</li>
 *   <li>{@link www.imta.fr.browserautomation.seleniumDsl.impl.ReadImpl#getNumber <em>Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReadImpl extends CommandImpl implements Read
{
  ...
  public EList<String> getElements()
  {
    if (elements == null)
    {
      elements = new EDataTypeEList<String>(String.class, this, SeleniumDslPackage.READ__ELEMENTS);
    }
    return elements;
  }
  ...
  public void setLinkText(String newLinkText)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SeleniumDslPackage.READ__LINK_TEXT, oldLinkText, linkText));
  }
  ...
  public void setNumber(int newNumber)
  {
    ...
    number = newNumber;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SeleniumDslPackage.READ__NUMBER, oldNumber, number));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SeleniumDslPackage.READ__ELEMENTS:
        return getElements();
      case SeleniumDslPackage.READ__LINK_TEXT:
        return getLinkText();
      case SeleniumDslPackage.READ__NUMBER:
        return getNumber();
    }
